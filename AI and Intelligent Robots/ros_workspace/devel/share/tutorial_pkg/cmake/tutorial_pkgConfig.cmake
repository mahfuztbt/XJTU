...
if("TRUE" STREQUAL "TRUE")
  set(tutorial_pkg_SOURCE_PREFIX /home/mahfuz/ros_workspace/src/tutorial_pkg)
  set(tutorial_pkg_DEVEL_PREFIX /home/mahfuz/ros_workspace/devel)
  ...
  set(tutorial_pkg_INSTALL_PREFIX /home/mahfuz/ros_workspace/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'mahfuz <mahfuz@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tutorial_pkg' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mahfuz/ros_workspace/src/tutorial_pkg/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/mahfuz/ros_workspace/devel/lib;/opt/ros/melodic/lib)
