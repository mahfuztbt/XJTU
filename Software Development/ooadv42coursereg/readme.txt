OOADv4.2 Course Registration Example Readme:
...
coursereg(analysis).mdl      Contains the model up to Architectural Design
coursereg(design).mdl        Contains the model from Architectural Design through Class Design
